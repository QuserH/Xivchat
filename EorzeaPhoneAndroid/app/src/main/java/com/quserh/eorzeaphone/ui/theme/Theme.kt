...
private fun lightPhoneColors(accent: AccentPalette) = lightColorScheme(
    ...
    tertiary = Color(0xFF5B6570),
    onTertiary = Color.White,
    tertiaryContainer = Color(0xFFE3E9EF),
    onTertiaryContainer = Color(0xFF1E262E),
    error = Color(0xFFC2323D),
    errorContainer = Color(0xFFFBE4E4),
    onErrorContainer = Color(0xFF4A1212),
    background = Color(0xFFF0F3F7),
    onBackground = Color(0xFF1F2730),
    surface = Color(0xFFFFFFFF),
    onSurface = Color(0xFF24312A),
    surfaceVariant = Color(0xFFECF0F5),
